...
Todo:
    * confirmt he new hyades_runner.py works with the GUI and excel functions, then delete this file
"""
...
def batchRunHyades(inf_path, final_destination, copy_data_to_excel, debug=1):
    ...
    for run_name in inf_files:
        ...
        if copy_data_to_excel:
            write_excel(os.path.join(final_destination, run_name, run_name),
